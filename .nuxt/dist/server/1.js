...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-meta.vue?vue&type=template&id=4290e78a&
var article_metavue_type_template_id_4290e78a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"article-meta"},[_c('nuxt-link',{attrs:{"to":{ name: 'profile', params: { username: _vm.article.author.username } }}},[_c('img',{attrs:{"src":_vm.article.author.image}})]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"info\">","</div>",[_c('nuxt-link',{staticClass:"author",attrs:{"to":{ name: 'profile', params: { username: _vm.article.author.username } }}},[_vm._v(_vm._s(_vm.article.author.username)+"\n    ")]),_vm._ssrNode(" <span class=\"date\">"+_vm._ssrEscape(_vm._s(_vm._f("date")(_vm.article.createdAt,"MMM DD,YYYY")))+"</span>")],2),_vm._ssrNode(" "),(_vm.article.author.username === _vm.$store.state.user.username)?[_c('nuxt-link',{staticClass:"btn btn-sm btn-outline-secondary",class:{ active: _vm.article.author.following },attrs:{"to":{
        name: 'editor',
        query: {
      ...
      }}},[_c('i',{staticClass:"ion-edit"}),_vm._v(" Edit Article\n    ")]),_vm._ssrNode("\n      \n    <button class=\"btn btn-sm btn-outline-primary btn-outline-danger\"><i class=\"ion-trash-a\"></i> Delete Article\n    </button>")]:_vm._ssrNode("<button"+(_vm._ssrAttr("disabled",_vm.followDisabled))+(_vm._ssrClass("btn btn-sm btn-outline-secondary",{ active: _vm.article.author.following }))+"><i class=\"ion-plus-round\"></i>\n       \n      "+((_vm.article.author.following)?("<span>Follow</span>"):("<span>Unfollow</span>"))+_vm._ssrEscape(_vm._s(_vm.article.author.username)+"\n    ")+"</button>\n      \n    <button"+(_vm._ssrAttr("disabled",_vm.followDisabled))+(_vm._ssrClass("btn btn-sm btn-outline-primary",{ active: _vm.article.favorited }))+"><i class=\"ion-heart\"></i>\n        Favorite Post\n      <span class=\"counter\">"+_vm._ssrEscape("("+_vm._s(_vm.article.favoritesCount)+"})")+"</span></button>")],2)}
var article_metavue_type_template_id_4290e78a_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-meta.vue?vue&type=template&id=4290e78a&
...
/* harmony default export */ var article_metavue_type_script_lang_js_ = ({
  ...
  methods: {
    async subscribeUser() {
      ...
      const subscrib = this.article.author.following ? user["d" /* unFollowUser */] : user["a" /* followUser */];
      const {
        data
      } = await subscrib(this.article.author.username);
    ...
    removeArticle() {
      Object(api_article["c" /* deleteArticle */])(this.article.slug);
      this.$router.go(-1);
    }
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  article_metavue_type_template_id_4290e78a_render,
  article_metavue_type_template_id_4290e78a_staticRenderFns,
  false,
  injectStyles,
  null,
  "2ed6aaf0"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-comments.vue?vue&type=template&id=92c08e88&
var article_commentsvue_type_template_id_92c08e88_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<form class=\"card comment-form\"><div class=\"card-block\"><textarea placeholder=\"Write a comment...\" rows=\"3\" class=\"form-control\">"+_vm._ssrEscape(_vm._s(_vm.comment))+"</textarea></div> <div class=\"card-footer\"><img src=\"http://i.imgur.com/Qr71crq.jpg\" class=\"comment-author-img\"> <button type=\"button\" class=\"btn btn-sm btn-primary\">\n        Post Comment\n      </button></div></form> "),_vm._l((_vm.comments),function(comment){return _vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-block\"><p class=\"card-text\">"+_vm._ssrEscape("\n        "+_vm._s(comment.body)+"\n      ")+"</p></div> "),_vm._ssrNode("<div class=\"card-footer\">","</div>",[_c('nuxt-link',{staticClass:"comment-author",attrs:{"to":{
          name: 'profile',
          params: {
        ...
        }}},[_vm._v("\n        "+_vm._s(comment.author.username)+"\n      ")]),_vm._ssrNode(" <span class=\"date-posted\">"+_vm._ssrEscape(_vm._s(_vm._f("date")(comment.createdAt,"MMM DD,YYYY")))+"</span> "+((comment.author.username === _vm.$store.state.user.username)?("<span class=\"mod-options\"><i class=\"ion-trash-a\"></i></span>"):"<!---->"))],2)],2)})],2)}
var article_commentsvue_type_template_id_92c08e88_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-comments.vue?vue&type=template&id=92c08e88&
...
/* harmony default export */ var article_commentsvue_type_script_lang_js_ = ({
  ...
  methods: {
    async releaseComment() {
      await Object(api_article["a" /* addComment */])(this.article.slug, this.comment);
      this.comment = "";
      const {
        data
      } = await Object(api_article["h" /* getComments */])(this.article.slug);
...
var article_comments_component = Object(componentNormalizer["a" /* default */])(
  ...
  article_commentsvue_type_template_id_92c08e88_render,
  article_commentsvue_type_template_id_92c08e88_staticRenderFns,
  false,
