...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=1a72e504&
...
// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=1a72e504&
...
/* harmony default export */ var editorvue_type_script_lang_js_ = ({
  ...
  async created() {
    if (this.$route.query.slug) {
      const {
        data
      } = await Object(api_article["f" /* getArticle */])(this.$route.query.slug);
      const {
        article
      } = data;
      this.article = {
  ...
  methods: {
    ...
    async addArticle() {
      try {
        const {
          data
        } = await Object(api_article["j" /* publishArticle */])(this.article);
        const {
          slug
        } = data.article;
